...
proc create_root_design { parentCell } {
  ...
  set TMDS_in_0 [ create_bd_intf_port -mode Slave -vlnv digilentinc.com:interface:tmds_rtl:1.0 TMDS_in_0 ]
  ...
  create_hier_cell_frontend [current_bd_instance .] frontend
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net TMDS_in_0_1 [get_bd_intf_ports TMDS_in_0] [get_bd_intf_pins frontend/TMDS_in]
  ...
  connect_bd_intf_net -intf_net frontend_DDC [get_bd_intf_ports DDC_0] [get_bd_intf_pins frontend/DDC]
  connect_bd_intf_net -intf_net frontend_video_out [get_bd_intf_pins color_convert_0/stream_in_24] [get_bd_intf_pins frontend/video_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins pixel_pack_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins color_convert_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins frontend/S00_AXILite] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins frontend/S02_AXILite] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  ...
  connect_bd_net -net frontend_hdmi_in_hpd [get_bd_ports hdmi_in_hpd_0] [get_bd_pins frontend/hdmi_in_hpd]
  connect_bd_net -net frontend_hdmi_in_hpd_irq [get_bd_pins frontend/hdmi_in_hpd_irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net frontend_vtc_in_irq [get_bd_pins frontend/vtc_in_irq] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins color_convert_0/control] [get_bd_pins frontend/clk_100M] [get_bd_pins pixel_pack_0/control] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins color_convert_0/ap_clk] [get_bd_pins frontend/clk_142M] [get_bd_pins pixel_pack_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins frontend/clk_200M] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins color_convert_0/ap_rst_n] [get_bd_pins color_convert_0/ap_rst_n_control] [get_bd_pins frontend/periph_resetn_clk100M] [get_bd_pins frontend/resetn] [get_bd_pins pixel_pack_0/ap_rst_n] [get_bd_pins pixel_pack_0/ap_rst_n_control] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins frontend/vid_io_in_reset] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs frontend/axi_gpio_hdmiin/S_AXI/Reg] SEG_axi_gpio_hdmiin_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs frontend/vtc_in/ctrl/Reg] SEG_vtc_in_Reg
